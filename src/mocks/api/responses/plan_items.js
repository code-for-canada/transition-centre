...
export default [
  {
    category: "Health",
    description:
      "Health - Funtioning Well Physically, Mentally, Socially and Spiritually",
    tasks: [
      {
        name: "Sign the necessary consents with your release",
        description:
          "Sign the necessary consents with your release description.",
      ...
      },
      {
        ...
        description:
          "Prepare a list of medication/ health treatment services and communicate with Medavie Blue Cross to confirm VAC coverage.",
      ...
      },
      {
        ...
        description:
          "Request a copy of your medical file and a doctor’s package description.",
        dueDate: mock_after_60_date,
        taskStatus: "",
        priority: "",
        memberNotes: "",
      ...
      },
      {
        ...
        description:
          "Ensure to obtain health and dental benefit plans for yourself and family description.",
        dueDate: mock_after_90_date,
        taskStatus: "",
        priority: "",
        memberNotes: "",
      ...
      },
      {
        ...
        description:
          "Acquire Gym membership and continue DFit program description.",
        dueDate: mock_after_90_date,
        taskStatus: "",
        priority: "",
        memberNotes: "",
    ...
    tasks: [
      {
        ...
        description:
          "Check your pension forecast and release benefits description",
        dueDate: mock_in_30_date,
        taskStatus: "",
        priority: "",
        memberNotes: "",
      ...
      },
      {
        ...
        description:
          "Identify any outstanding CAF debts (CANEX, mess, etc.) and plan payment schedule description",
        dueDate: mock_after_60_date,
        taskStatus: "",
        priority: "",
        memberNotes: "",
      ...
      },
      {
        ...
        description:
          "Confirm your life insurance requirements after release description",
        dueDate: mock_after_90_date,
        taskStatus: "",
        priority: "",
        memberNotes: "",
  ...
  },
  {
    ...
    description:
      "Social Integration - In Mutualy Supportive Relationships and Engaged in Community",
    tasks: [
      {
        name: "Exchange personal contact info with military peers",
        description:
          "Consider exchanging personal contact info for military peers / connections you would like to stay in touch with.",
        dueDate: mock_after_60_date,
        taskStatus: "",
        priority: "",
        memberNotes: "",
      ...
      },
      {
        ...
        description:
          "Build your social contact network external to your military circles description.",
        dueDate: mock_after_60_date,
        taskStatus: "",
        priority: "",
        memberNotes: "",
      ...
      },
      {
        ...
        description:
          "Consider joining groups with similar beliefs, language, culture, etc. description.",
        dueDate: mock_after_60_date,
        taskStatus: "",
        priority: "",
        memberNotes: "",
      ...
      },
      {
        ...
        description:
          "Build your online social media contact list (e.g., Facebook, Instagram, etc.) description.",
        dueDate: mock_after_60_date,
        taskStatus: "",
        priority: "",
        memberNotes: "",
  ...
  },
  {
    ...
    description:
      "Housing and Physical Environment - Living in Safe, Adequate, Affordable Housing",
    tasks: [
      {
        name: "Ensure your contact information is current",
        description:
          "Ensure your contact information is current (CAF, VAC, bank etc).",
        dueDate: mock_after_90_date,
        taskStatus: "",
        priority: "",
        memberNotes: "",
  ...
  },
  {
    ...
    description:
      "Life Skills and Preparedness - Able to Adapt, Manage and Cope Within Civilian Life",
    tasks: [
      {
      ...
      },
      {
        ...
        description:
          "Calculate leave to determine how to use your remaining leave description.",
        dueDate: mock_in_30_date,
        taskStatus: "",
        priority: "",
        memberNotes: "",
      ...
      },
      {
        ...
        description:
          "Participate in your first CAF transition interview description.",
        dueDate: mock_in_30_date,
        taskStatus: "",
        priority: "",
        memberNotes: "",
      ...
      },
      {
        ...
        description:
          "Maintain a file of all important documents and certificates for ready reference description.",
        dueDate: mock_in_30_date,
        taskStatus: "",
        priority: "",
        memberNotes: "",
      ...
      },
      {
        ...
        description:
          "Make an appointment with your orderly room of your unit to complete Out-Clearance description.",
        dueDate: mock_after_30_date,
        taskStatus: "",
        priority: "",
        memberNotes: "",
      ...
      },
      {
        ...
        description:
          "Complete the Enhanced Transition Training through the DLN description.",
        dueDate: mock_in_30_date,
        taskStatus: "",
        priority: "",
        memberNotes: "",
      ...
      },
      {
        ...
        description:
          "Plan and participate in your Depart with Dignity ceremony description.",
        dueDate: mock_after_90_date,
        taskStatus: "",
        priority: "",
        memberNotes: "",
      ...
      },
      {
        ...
        description:
          "Meet with a notary or lawyer to draft a power of attorney description.",
        dueDate: mock_after_90_date,
        taskStatus: "",
        priority: "",
        memberNotes: "",
      ...
      },
      {
        ...
        description:
          "Meet with a notary or lawyer to write a will description.",
        dueDate: mock_after_90_date,
        taskStatus: "",
        priority: "",
        memberNotes: "",
      ...
      },
      {
        ...
        description:
          "Maintain a healthy lifestyle plan (Personal Support Program) description.",
        dueDate: mock_after_90_date,
        taskStatus: "",
        priority: "",
        memberNotes: "",
