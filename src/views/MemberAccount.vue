  ...
  <div id="member-account-container">
    ...
    <main property="mainContentOfPage" resource="#wb-main" typeof="WebPageElement" class="container">
      ...
      <div class="row mrgn-tp-lg mrgn-bttm-lg">
        <div class="col-xs-12">
          <router-link to="/accountedit" class="btn btn-default">Edit preferences</router-link>
        </div>
      </div>
      <section>
        ...
        <div class="row mrgn-bttm-lg">
          <div class="col-xs-12">
            <label for="communications-preferences" class="mrgn-bttm-0">Automated communications:</label>
